...
![GitHub commit activity](https://img.shields.io/github/commit-activity/t/sqlmerr/voidspace)
![Github Created At](https://img.shields.io/github/created-at/sqlmerr/voidspace)
![GitHub last commit](https://img.shields.io/github/last-commit/sqlmerr/voidspace)
...
**VoidSpace** is a space travelling game. Explore different locations. Travel to interesting systems and planets. Gather
resources and create your own base (in future updates). You can play it in telegram bot!
