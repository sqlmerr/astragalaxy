...
export interface paths {
    ...
    "/api/v1/ships/my/{id}/modules/{type}": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /**
         * Remove Ship Module
         * @description Removes ship's module and gives you an item, that represents this module (inventory must not be full)
         */
        delete: operations["removeShipModule"];
        options?: never;
        head?: never;
        patch?: never;
        trace?: never;
...
export interface operations {
    ...
    removeShipModule: {
        ...
        requestBody?: never;
        responses: {
            /** @description Successfully removed ship module */
            204: {
                headers: {
                    [name: string]: unknown;
                };
            ...
            401: components["responses"]["InvalidAgentToken"];
            403: components["responses"]["AccessDenied"];
            /** @description Can't remove ship module */
            422: {
                headers: {
                    [name: string]: unknown;
                };
