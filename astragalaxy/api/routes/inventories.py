...
from astragalaxy.api.dependencies import CharacterSecurity, JwtSecurity
...
@router.get("/{owner}/{id}/items", dependencies=[JwtSecurity, CharacterSecurity])
...
@router.get("/{inventory_id}/items", dependencies=[JwtSecurity, CharacterSecurity])
...
@router.get("/{owner}/{id}/resources", dependencies=[JwtSecurity, CharacterSecurity])
...
@router.get("/{inventory_id}/resources", dependencies=[JwtSecurity, CharacterSecurity])
